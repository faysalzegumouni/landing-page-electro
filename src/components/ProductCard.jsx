...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="product-page">
      {/* Titre du produit en haut à gauche */}
      ...
      <div className="product-layout">
        ...
        <div className="product-details">
          ...
          <p className="price"><strong>Prix :</strong> ${product.price.toFixed(2)}</p>

          {/* Caractéristiques et Détails côte à côte (ou en colonne sur mobile) */}
          <div className="features-section">
            <div className="product-features">
              <h3>✨ Caractéristiques</h3>
              <ul>
                <li><strong>Boîtier :</strong> 400 mAh</li>
                <li><strong>Réduction bruit :</strong> Oui</li>
                <li><strong>Écouteur :</strong> 25 mAh</li>
                <li><strong>BT Distance :</strong> 10 m</li>
                <li><strong>Port :</strong> Type-C</li>
                <li><strong>Pilote :</strong> 14mm Bass Boost</li>
                <li><strong>Autonomie :</strong> 5h lecture</li>
                <li><strong>Recharges :</strong> +5 via boîtier</li>
              </ul>
            </div>
        ...
        {/* Bouton principal avec icône WhatsApp */}
<a
